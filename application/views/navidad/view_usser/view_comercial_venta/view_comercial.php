    ...
    <div id="pn_Panneau_Utilisateur" >
        <div id="pn_cont_information_usser_corp" class="pn_cont_information_corp">
            ...
            <div class="pn_option_select">
                ...
                <a href="<?php echo site_url("navidad/c_comercial/pn_view_alta_restaurante"); ?>" >
                    <div id="pn_pedido">

                    </div>
                    <div>Alta restaurante</div>
                </a>
            </div>
             <div class="pn_option_select">
                        <a href="<?php echo site_url("navidad/c_comercial/pn_change_pasword_cmv");?>" >
                        <div id="pn_pedido">
